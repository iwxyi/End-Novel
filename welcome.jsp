...
<body>
	<svg class="hidden">
		...
		<main class="landing-layout">
			...
			<div class="landing-wrap">
				<section class="landing landing--above" style="background-image: url(img/welcome_bg_1.jpg);"></section>
				<section class="landing landing--beneath" style="background-image: url(img/welcome_bg_2.jpg);">
					<canvas id="bubbles"></canvas>
				</section>
			</div><!-- /landing-wrap -->
			<!-- Landing header with title -->
			<header class="landing-header">
				<h1 class="landing-header__title" aria-label="欢迎进入 终点小说">
					终点小说
				</h1>
				<p class="landing-header__tagline"><a href="index.jsp">前往首页</a></p>
				...
				<ul class="featured-list">
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							...
							<h3 class="featured-list__title"><a href="announcement.jsp">网站公告</a></h3>
						</a>
					</li>
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							<img class="featured-list__img" src="img/icons/sw2.svg" alt="Seaweed 2">
							<h3 class="featured-list__title"><a href="shelf.jsp">我的书架</a></h3>
						</a>
					</li>
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							<img class="featured-list__img" src="img/icons/sw3.svg" alt="Seaweed 3">
							<h3 class="featured-list__title"><a href="rankpage.jsp">小说排行</a></h3>
						</a>
					</li>
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							<img class="featured-list__img" src="img/icons/sw4.svg" alt="Seaweed 4">
							<h3 class="featured-list__title"><a href="writerpage.jsp"></a>作者专区</h3>
						</a>
					</li>
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							<img class="featured-list__img" src="img/icons/sw5.svg" alt="Seaweed 5">
							<h3 class="featured-list__title"><a href="money.jsp">余额查询</a></h3>
						</a>
					</li>
					<li class="featured-list__item">
						<a href="#" class="featured-list__link">
							<img class="featured-list__img" src="img/icons/sw6.svg" alt="Seaweed 6">
							<h3 class="featured-list__title"><a href="about.jsp">关于网站</a></h3>
						</a>
					</li>
				</ul>
	...
	<script src="js/welcome_howler.min.js"></script>
	<script src="js/welcome_imagesloaded.pkgd.min.js"></script>
	<script src="js/welcome_main.js"></script>
</body>
</html>