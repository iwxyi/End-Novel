...
<html>
  ...
  <div class="mdui-tab mdui-tab-centered" mdui-tab>
    ...
    <a href="zpgl2.jsp" class="mdui-ripple mdui-tab-active">未发表作品</a>
    ...
    <div class="mdui-col-sm-6 mdui-col-md-4">
      <div class="mdui-card">
        <div class="mdui-card-media">
          <img src="https://qidian.qpic.cn/qdbimg/349573/1010868264/150"/>
          <div class="mdui-card-media-covered mdui-card-media-covered-transparent">
            <div class="mdui-card-primary">
              <div class="mdui-card-primary-title">诡秘之主</div>
              <div class="mdui-card-primary-subtitle">爱潜水的乌贼</div>
            </div>
          </div>
        </div>
        <div class="mdui-card-actions">
          <button class="mdui-btn mdui-ripple">编辑信息</button>
          <button class="mdui-btn mdui-ripple">删除</button>
        </div>
      </div>
    </div>
  </div>
